...
let ArchitectTools = class ArchitectTools {
    async createProjectBlueprint(input, ctx) {
...
], ArchitectTools.prototype, "createProjectBlueprint", null);
ArchitectTools = __decorate([
    Injectable()
], ArchitectTools);
export { ArchitectTools };
